...
public class PictureController {
    ...
    @PostMapping("/picture/presign")
    public ResponseBody<PresignPutResponse> presign(@RequestBody PresignPutRequest request) {
        PresignPutResponse response = uploadService.presignPut(request);
